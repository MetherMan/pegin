...
const info={name:'Bloodfang Openwork Spear',triangles:stats.reduce((a,b)=>a+b.triangles,0),mesh_objects:stats.length,chain_links:count,fur_strands:500,source:'concept_texture.png',construction:'New reference-guided 3D geometry. Pierced extruded blade with thickness and bevels, raised heraldry, toroidal chain links, circular haft and dimensional tapered fur strands.',surface:'Blade uses projected concept texture; some original lighting/detail is baked into this texture. Back uses mirrored front appearance. Other components have PBR materials.',not_in_game:false,parts:stats};
