...
const info={name:'푸른달의 트와일라잇 양손검',rank:9,name_color:'#72CFFF',rank_color:'#348BFF',type:2,triangles:stats.reduce((a,b)=>a+b.triangles,0),mesh_objects:stats.length,cloth_strips:0,source:'concept_texture.png',revision:'approved design 04',construction_transform:{pixel_scale:S*scale,x_origin:CX,y_offset:CY*S*scale+root.position.y},not_in_game:false,construction:'Extruded approved 04 silhouette with genuine upper slit and circular aperture, irregular integrated auxiliary cutters, textured sidewalls, cylindrical two-hand grip and crescent pommel. One rigid animation mesh in native export.',parts:stats};
