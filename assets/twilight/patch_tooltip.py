...
for base in [0x10000000,0x03500000]:
 ...
 for rank in range(1,21):
  for item in [11445,19000,19029,19030,19040,19050,19051]:
   ...
   color=0xff72cfff if 19030<=item<=19050 else default
...
(O/'tooltip_validation.json').write_text(json.dumps(dict(passed=True,cases=cases,rank_color='#72CFFF',name_color='#72CFFF',item_range=[19030,19050],two_image_bases=True,sha256=hashlib.sha256(b).hexdigest()),indent=2))
