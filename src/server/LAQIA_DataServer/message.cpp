...
BOOL DeleteCharacter( sPDESC_DATA pClient )
{
	...
	sprintf( query, "delete from UserFriends where ownerid='%s' and ownerpos=%d", escID, charPos );
...
//
BOOL SavePlayer( sPDESC_DATA pClient )
{
	char id[128];
...
BOOL (*MessageFuncsList[])( sPDESC_DATA pClient ) =
{
	...
	UpdateCash,					//#define 
	SavePlayer,//SaveCharData,				//dDATA_PACKET_SAVE_CHA
};
